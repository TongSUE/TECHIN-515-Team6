      ...
      people: [
        {
          ...
          weeks: [
            ...
            },
            {
              label: 'Week 3',
              items: [
                'I2S mic bring-up + ESP-SR wake-word pipeline',
            ...
            },
            {
              ...
              items: [
                ...
                'Power optimization (WiFi modem sleep)',
                'Mobile app — spray history viewer (Expo + RN)',
              ],
            },
            {
              label: 'Week 5',
              items: [
                'Mobile app real-time display (Expo SDK 54)',
                'Devlog write-up',
              ],
            },
            {
              label: 'Week 6',
              items: [
                'PCB v1 — circular R=45 mm, JST footprints, LPKF milled',
                'Milestone 2 slides',
                'Devlog write-up',
              ],
            },
            {
              label: 'Week 7',
              items: [
                'App UI — icons, IAQ pill, reservoir reset',
                'Device online status header',
                'Lid casting · Open House demo',
                'Devlog write-up',
              ],
            },
            {
              ...
              items: [
                'PCB soldering',
                'Enclosure — SLA print, wet sand, lid repair',
                'Full assembly',
                'Devlog write-up',
              ],
            },
        ...
        {
          role: 'Hardware · ML · Firmware · CAD',
          bio: 'Drives hardware and ML. Brought up BME680, built the IAQ MLP + Shower CNN pipeline, integrated trained models into firmware, led enclosure CAD, and developed AuraSync firmware from v3 to v4.',
          weeks: [
            {
              label: 'Week 1',
              items: [
            ...
            },
            {
              label: 'Week 3',
              items: [
                'PIR sensor bring-up + atomizer circuit',
                'Milestone 1 slides',
              ],
            },
            {
              label: 'Week 4',
              items: [
                'BME680 bring-up & I2C validation',
                'Dual-layer state machine (co-designed)',
              ],
            },
            {
              label: 'Week 5',
              items: [
                'BME680 data collection (16 927 readings)',
                'IAQ MLP + Shower CNN (Val F1 0.77, AUC 0.94)',
                'BSEC2 firmware upgrade',
              ],
            },
            {
              label: 'Week 6',
              items: [
                'ML on-device inference — C headers, Val F1 0.902',
                'Enclosure v2 (cylindrical snap-fit, PLA)',
                'Milestone 2 slides',
              ],
            },
            {
              label: 'Week 7',
              items: [
                'AuraSync v4 — DEMO_MODE, VOC+PIR latch, all 5 triggers',
                'Enclosure v3 CAD',
                'Lid casting · Open House demo',
              ],
            },
            {
              label: 'Week 8',
              items: [
                'WS2812B LED ring — 5 state animations',
                'Voice tuning — "Release" keyword',
                'Full assembly',
